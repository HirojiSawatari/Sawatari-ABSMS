...
{
    public partial class 车辆管理系统 : Form
    {
        ...
        private void 车辆管理系统_Load(object sender, EventArgs e)
        {
            ...
            my_ds = new DataSet();
            my_adapter = new SqlDataAdapter("select usetime,busend,cost from line", my_conn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string s_select;
            s_select = "select * from bus where busend='" + s_end + "'";
