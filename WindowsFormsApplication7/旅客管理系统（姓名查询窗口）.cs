...
{
    public partial class 旅客管理系统_姓名查询窗口_ : Form
    {
        SqlConnection my_conn;
        SqlDataAdapter my_adapter;
        DataSet my_ds;
        BindingSource my_bind;
        public 旅客管理系统_姓名查询窗口_()
        {
            InitializeComponent();
        }

        private void 旅客管理系统_姓名查询窗口__Load_1(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            s_select = "select id,name,num from peo where name like'" + s_end + "%'";
