...
{
    public partial class 车辆管理系统_车牌号查询窗口_ : Form
    {
        SqlConnection my_conn;
        SqlDataAdapter my_adapter;
        DataSet my_ds;
        BindingSource my_bind, my_bind2;
        public 车辆管理系统_车牌号查询窗口_()
        {
            InitializeComponent();
        }

        private void 车辆管理系统_车牌号查询窗口__Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string s_select;
            s_select = "select * from bus where num='" + s_end + "'";
