...
{
    public partial class 旅客管理系统_车辆查询窗口_ : Form
    {
        SqlConnection my_conn;
        SqlDataAdapter my_adapter;
        DataSet my_ds;
        BindingSource my_bind;
        public 旅客管理系统_车辆查询窗口_()
        {
            InitializeComponent();
        }

        private void 旅客管理系统_车辆查询窗口__Load(object sender, EventArgs e)
        {
            ...
            my_adapter = new SqlDataAdapter("select id,name,num from peo", my_conn);
            my_ds = new DataSet();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            s_end = comboBox1.Text.Trim();
            if (my_conn.State == ConnectionState.Closed)
            {
                my_conn.Open();
            }
            s_select = "select id,name,num from peo where num like'" + s_end + "%'";
